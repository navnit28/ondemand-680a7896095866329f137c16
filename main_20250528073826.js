...
async function submitQuery(apiKey, sessionId, queryText, responseMode = "sync") {
    ...
    const body = JSON.stringify({
        ...
        query: queryText,
        agentIds: ["agent-1713962163","agent-1745475776","agent-1730662083","agent-1722260873","agent-1713954536","agent-1713958591","agent-1713958830","agent-1713961903","agent-1713967141"],
